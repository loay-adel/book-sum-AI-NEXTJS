// components/ContactUsClient.jsx
"use client";
...
const ContactUsClient = ({ lang = "en", dictionary }) => {
  ...
  // Use passed dictionary or fallback to static
  const dict = dictionary?.contact || staticDict[lang] || staticDict.en;
